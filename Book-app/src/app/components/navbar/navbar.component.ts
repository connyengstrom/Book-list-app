...
export class NavbarComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    if (this.darkModeSwitch) {
      this.darkModeSwitch.nativeElement.querySelector('.mdc-switch__icon--on').firstChild.setAttribute('d', this.sun);
      this.darkModeSwitch.nativeElement.querySelector('.mdc-switch__icon--off').firstChild.setAttribute('d', this.moon);
    }
  }
